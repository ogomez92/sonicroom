...
public static class I18n
{
    ...
    private static readonly Dictionary<string, (string En, string Es, string Fr)> Table = new()
    {
        ...
        ["play_file"] = ("Play file", "Reproducir archivo", "Lire un fichier"),
        ["stop_file"] = ("Stop file", "Detener archivo", "Arrêter le fichier"),
        ["change_file"] = ("Change file", "Cambiar archivo", "Changer de fichier"),
        ...
        ["mic_gain_name"] = ("Microphone gain", "Ganancia del micrófono", "Gain du microphone"),
        ["master"] = ("Master", "General", "Général"),
        ["master_volume_name"] = ("Master volume", "Volumen general", "Volume général"),
        ...
        ["volume_label"] = ("Volume for {0}", "Volumen de {0}", "Volume de {0}"),
        ...
        ["file_started_peer"] = ("{0} started streaming a file", "{0} ha empezado a emitir un archivo", "{0} a commencé à diffuser un fichier"),
        ["file_stopped_peer"] = ("{0} stopped streaming a file", "{0} ha dejado de emitir un archivo", "{0} a arrêté de diffuser un fichier"),
        ...
        ["you_stopped_file"] = ("You stopped streaming the file", "Has dejado de emitir el archivo", "Vous avez arrêté de diffuser le fichier"),
        ["file_failed"] = ("File playback failed: {0}", "La reproducción del archivo ha fallado: {0}", "Échec de la lecture du fichier : {0}"),
        ...
        ["source_file"] = ("file stream", "archivo en emisión", "flux de fichier"),
